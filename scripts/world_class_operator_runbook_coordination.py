...
COORDINATION_GUIDANCE: dict[str, dict[str, str]] = {
    "provider-holdout": {
        ...
        "command": "python3 scripts/yao.py evidence-build . --run-id <PROVIDER_RUN_ID>",
    ...
    "human-adjudication": {
        ...
        "command": "python3 scripts/yao.py evidence-finalize-review . --source-run <PROVIDER_RUN_ID> --decisions <A.json> --decisions <B.json> --decisions <C.json> --reviewer-registry <registry.json>",
