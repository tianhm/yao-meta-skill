...
| Trust | `0` secret findings, `1` pinned dependency file, `72` declared internal modules, `3 / 3` network-capable scripts covered by bounded host policy, `89 / 89` CLI help smoke checks passing across `161` scripts, source-contract hash scope explicit |
