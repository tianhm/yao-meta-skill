...
| Trust | `0` secret findings, `1` pinned dependency file, `72` declared internal modules, `3 / 3` network-capable scripts covered by bounded host policy, `90 / 90` CLI help smoke checks passing across `162` scripts, source-contract hash scope explicit |
