...
| Trust | `0` secret findings, `1` pinned dependency file, `71` declared internal modules, `3 / 3` network-capable scripts covered by bounded host policy, `87 / 87` CLI help smoke checks passing across `158` scripts, source-contract hash scope explicit |
